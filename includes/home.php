    ...
    <div class="home-content">
        <div class="overview-boxes">
            ...
            <div class="box">
             ...
             <div class="box">
                <div class="right-side">
                    <div class="box-topic"> Fix Month target</div>
                    <div class="number" id="month target">60000</div>
                    <div class="indicator"><i class='bx bx-up-arrow-alt'></i><span class="text">Up from month</span></div>
                </div>
                <i class="fas fa-wallet cart two"></i>
            </div>
